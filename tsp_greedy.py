...
# def swapEdges(path,x,y,z,n):
#     A=[]
#     for i in range(x+1):
#         A.append(path[i])
#     for i in range(y,x,-1):
#         A.append(path[i])
#     for i in range(z-1,y,-1):
#         A.append(path[i])
#     for i in range(z,len(path)):
#         A.append(path[i])
#     return A
...
#             v=edge[path[i]][path[i+1]]+edge[path[j]][path[j+1]]+edge[path[k-1]][path[k]]
#             s=edge[path[i]][path[j]]+edge[path[j+1]][path[k]]+edge[path[i+1]][path[k-1]]
#             if s<v:
#                 path=swapEdges(path,i,j,k,n)
#                 printPath(path,n)
